...
class Main extends React.Component {
  ...
  openImage = () => {
    const base_image_dee = new Image();
    base_image_dee.src = this.state.currentImage;
    base_image_dee.crossOrigin = "anonymous";
    var base64 = "";
    setTimeout(() => {
      base64 = this.getBase64Image(base_image_dee);
      if (base64) {
        this.setState({
          isOpen: true,
  ...
  render() {
    ...
    var wrh = this.state.ImageWidth / this.state.ImageHeight;
    var newWidth = 600;
