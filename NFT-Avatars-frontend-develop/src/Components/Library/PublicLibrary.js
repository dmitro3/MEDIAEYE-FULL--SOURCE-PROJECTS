...
import "./Library.scss";
// import Publictab from "./PublicTabs";
// import demoavt from "../../assets/images/avtdemo.png";
    ...
    <React.Fragment>
      <div className="medialibrarypage">
        ...
        <div className="library-tabs-inner">
          ...
          { toggle2D ?  null : <button className={selectData === "All" ? "btntab active": "btntab"} onClick={() => {searchData("All")}}>All Content</button> }
          <button className={selectData === "2D" ? "btntab active": "btntab"} onClick={() => {searchData("2D")}}>2D Content</button>
          { toggle2D ? null :  <button className={selectData === "3D" ? "btntab active": "btntab"} onClick={() => {searchData("3D")}}>3D Content</button>}
        ...
        <div className="library-tabs-right">
          ...
          <div className="mediaLibrarypage-contentdata">
            <PublicCard type={selectData}/>
          </div>
          <div className="mediaLibrarypage-uploaddata" onClick={()=>show2D()}>
