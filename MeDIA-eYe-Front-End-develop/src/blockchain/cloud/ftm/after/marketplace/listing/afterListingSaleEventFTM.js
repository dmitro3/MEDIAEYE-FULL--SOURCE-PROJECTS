Moralis.Cloud.afterSave('EventFTMListingSale', async (request) => {
  ...
  for (let i = 0; i < listingNFTs.length; i++) {
    ...
    newSale.set('chain', 'FTM');
    newSale.set('currency', 'FTM');
    ...
    userSpendingQuery.equalTo('chain', '0xfa');
    ...
    if (userSpending !== undefined) {
      ...
      newUserSpending.set('chain', '0xfa');
