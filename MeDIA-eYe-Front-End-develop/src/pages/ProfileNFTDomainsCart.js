...
import NFTDomainsCart from '../components/NFTDomainsCart/NFTDomainsCart';

const ProfileNFTDomainsCart = (props) => {
  ...
  return (
    <React.Fragment>
      <Helmet>
        <meta
          property="og:url"
          content={window.location.origin + '/profile/nftdomains/cart'}
        />
        ...
        <meta
          ...
          content="mediaeyenft.com/profile/nftdomains/cart"
        />
        <meta
...
export default ProfileNFTDomainsCart;
