...
export function LiveCampaign() {
    ...
    const smililarSlidersettings = {
        ...
        modules: [Pagination],
        pagination: {
            el: '.mediaeye-campaign-pagination-live',
            enable: true,
            clickable: true
        },
        breakpoints: {
    ...
    return (
        <>
            ...
            <div className="m-t-30 mediaeye-swiper-pagination mediaeye-swiper-pagination-center withscroll mediaeye-campaign-pagination-live"></div>
        </>
    );
}
