...
const MarketplaceSpotlightFilters = (props) => {
        ...
        <div className='marketplace-page-filters'>
            <div className='marketplace-page-filters-col marketplace-page-filters-search' size="3">
                <div className="mediaeye-searchbar">
                    <input placeholder="Search by spotlight" type="text" value={filters.search} onChange={(e) => { updateFilterValue('search', e.target.value) }} />
                </div>
            </div>
...
export default MarketplaceSpotlightFilters;
